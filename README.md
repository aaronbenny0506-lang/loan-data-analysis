...
├── loan.csv                  # Dataset
├── relationship_scatter.png  # Output plot
├── correlation_heatmap.png   # Output plot
├── requirements.txt
└── README.md
```
...
console, and save two plots (`relationship_scatter.png`,
`correlation_heatmap.png`) to the repo root.
